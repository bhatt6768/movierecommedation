...
//      $ot=shell_exec('python cliltering.py');
//  $myfile = fopen("movies.txt", "w") or die("Unable to open file!");
...
.review-block-description{
 ...
 //                axios({
 //   method: "post",
 //   url: 'http://192.168.225.39:8085/Test.php',
 //   timeout: 120000, // Wait for 5 seconds
 ...
 // })
    ...
    axios.post('http://192.168.225.39:8085/Testnewuser.php')
        //  axios.get('http://www.omdbapi.com/?apikey=a15bc27e&s=' + searchText)
        .then((response) => {
            console.log(response);
...
?>
    ...
    <div class="top_movies">
        <button type="submit" name="submit" onclick ="getJJ()"class="btn btn-info">Recommend Me!</button> <p><img src="preloader_4.gif" id="loaderIcon" style="display:none" /></p>
...
$pid=$_SESSION['uid'];
 $con=mysqli_connect("localhost","root", "","movierec") or die("The connection to the database has not been made");
$ret=mysqli_query($con,"select Genre from user where userId='$pid'");
...
?>
    ...
    <div class="top_movies">
        <button type="submit" name="submit" onclick ="getJ()"class="btn btn-info">Recommend Me!</button> <p><img src="preloader_4.gif" id="loaderIcon" style="display:none" /></p>
          Movies based on <b> <?php echo $row['Genre']; ?></b>:<br>
                                <div class="tab_movies_agileinfo">
                                        <div class="w3_agile_featured_movies two">
